...
class MensajesController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const users = yield database_1.default.query('SELECT * FROM Mensaje where idChat=? and estado!="borrado" ', [id]);
            res.json(users);
            console.log(users);
        });
    }
    ...
    delete(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            yield database_1.default.query('update Mensaje set estado="borrado" where idMensaje=?', [id]);
